...
import AdminSubjectList from "./Components/Dashboard/AdminSubjectList";
import AdminAnalysis from "./Components/Dashboard/AdminAnalysis";
...
import TeacherDashboard from "./Components/TeacherDashbaord/TeacherDashboard";
import TeacherSubjectList from "./Components/TeacherDashbaord/TeacherSubjectList";
import TeacherAnalysis from "./Components/TeacherDashbaord/TeacherAnalysis";
import TeacherSettings from "./Components/TeacherDashbaord/TeacherSettings";
          ...
          <div className="main-content">
            ...
            >
              <Routes>
                ...
                <Route
                  path="/class/:classId/learners"
                  element={<ManageLearners />}
                />
                <Route
                  path="/class/:classId/subject/:subjectId/formal-tasks"
                  element={<FormalTaskMarkEntry />}
                />
                <Route
                  path="/class/:classId/subject/:subjectId/task/:taskName/marks"
                  element={<MarkEntryPage />}
                />
                <Route
                  path="/analysis/:taskType/:subjectId/select"
                  element={<SubjectAnalysisSelectionPage />}
                />
                <Route
                  path="/analysis/:taskType/:subjectId/task/:taskId"
                  element={<SingleTaskAnalysisPage />}
                />
                <Route
                  path="/analysis/:taskType/:subjectId/term/:termId"
                  element={<TermAnalysisPage />}
                />
                <Route
                  path="/class/:classId/subject/:subjectId/informal-tasks"
                  element={<InfromalTaskMarkEntry />}
                />
                <Route
