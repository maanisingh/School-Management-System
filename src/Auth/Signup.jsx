...
const Signup = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="text-center mb-4">
          <h2 style={{ fontWeight: "700", color: "#A5B4FC", fontSize: "2rem" }}>
            Fundisa Results Analyser
          </h2>
        ...
        <form onSubmit={handleSignup}>
          ...
          {/* Same as your original code — no changes needed visually */}
          ...
          <div className="text-center">
            ...
            <Link to="/" style={{ color: "#A5B4FC", fontWeight: "600" }}>
              Login
            </Link>
          </div>
        </form>
