...
const allMenus = {
  admin: [
    ...
    { name: "Subject List", icon: faBookOpen, path: "/admin-subjectlist" },
    { name: "Analysis", icon: faChartBar, path: "/admin-analysis" },
    { name: "Teachers", icon: faUsers, path: "/admin-teachers" },
    { name: "AdminSettings", icon: faCog, path: "/admin-settings" },
  ...
  teacher: [
    ...
    { name: "Subject List", icon: faBookOpen, path: "/teacher-subjectlist" },
