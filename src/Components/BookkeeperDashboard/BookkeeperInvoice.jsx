...
const BookkeeperInvoice = () => {
  const stats = [
    { title: "Outstanding AR", value: "$72,250", icon: "💵" },
    { title: "Overdue Invoices", value: "8", icon: "⚠" },
  ...
  return (
    ...
    >
      ...
      <div className="d-flex align-items-center mb-4">
        ...
        >
          <strong>🔒 Bookkeeper Dashboard</strong>
        </div>
      </div>
      ...
      <Card className="shadow-sm border-0 mb-4">
        <Card.Body>
       <div className="d-flex justify-content-end align-items-center" style={{ gap: "10px", flexWrap: "nowrap" }}>
