    ...
    <div style={styles.page}>
      <Container fluid>
        ...
        <h2 style={styles.heading}>
          <FaUserCog style={styles.iconActive} /> Settings
        </h2>
        ...
        <Row xs={1} md={2} className="g-4">
          ...
          <Col>
            ...
            >
              <Card.Body>
                <h5 style={{ color: "#1e2a38", marginBottom: "15px" }}>
                  <FaUser style={{ color: "#7e3af2", marginRight: "8px" }} />
                  Edit Profile
                </h5>
          ...
          <Col>
            ...
            >
              <Card.Body className="d-flex flex-column align-items-center justify-content-center text-center">
                ...
                <p style={{ color: "#1e2a38", fontSize: "14px" }}>
